...
<p class="has-text-align-center has-muted-color has-text-color has-large-font-size">Seven Days of Healing, Integration, and Transformation</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","textColor":"muted","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"760px"}} -->
<p class="has-text-align-center has-muted-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--50)">Nestled in the heart of the Verde Valley, just outside Sedona, Lumina offers an intimate retreat experience designed to support deep healing, self-discovery, and lasting transformation. Through guided ceremonies, the 4-E Elemental Wisdom Process, daily Qi Gong, nourishing meals, nature immersion, and meaningful community, guests are supported in uncovering and transforming the patterns that no longer serve them.</p>
<!-- /wp:paragraph -->
...
<p class="has-muted-color has-text-color">Arrive and settle in, then gather for a welcome dinner, Bobinsana tea, and an opening circle where Ash opens the ceremonial space. Guests receive their journals and 4-E workbooks and begin setting intentions for the week.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"muted"} -->
<p class="has-muted-color has-text-color">Morning meditation and teachings, a restful day to settle into the rhythm, then tea, intention setting, and the first Ayahuasca ceremony in the evening.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"muted"} -->
<p class="has-muted-color has-text-color">Morning Qi Gong, then the first full 4-E process working with what surfaced in ceremony. Open afternoon for rest, journaling, or river walks, and an evening tea gathering.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"muted"} -->
<p class="has-muted-color has-text-color">Qi Gong and breakfast, late morning for nature immersion and optional hikes, then ceremony preparation and the second Ayahuasca ceremony in the evening.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"muted"} -->
<p class="has-muted-color has-text-color">Qi Gong, then the second 4-E process to uncover the roots of recurring patterns and integrate the night before. Open afternoon, then evening tea, dinner, and music.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"muted"} -->
<p class="has-muted-color has-text-color">Qi Gong and a spacious morning for reflection, then preparation and the third and final Ayahuasca ceremony in the evening.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"muted"} -->
<p class="has-muted-color has-text-color">Qi Gong, then the final 4-E process focused on carrying the work into everyday life, followed by completion exercises, a final tea, and a closing circle of gratitude.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"muted"} -->
<p class="has-muted-color has-text-color">A final pancake breakfast together before departing, carrying the tools, insights, and transformation home.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></section>
<!-- /wp:group -->
